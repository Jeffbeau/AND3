...
#  include "domzgr_substitute.h90"
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/DOM/domain.F90,v 1.17 2006/03/10 10:55:38 opalod Exp $ 
...
! ... Control of output frequency
      ...
      IF(lwp) THEN
         ...
         WRITE(numout,*) '           flag read/compute coordinates  ngrid     = ', ngrid
