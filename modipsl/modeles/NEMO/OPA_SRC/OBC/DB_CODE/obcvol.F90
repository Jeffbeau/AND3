...
#  include "obc_vectopt_loop_substitute.h90"
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/OBC/obcvol.F90,v 1.5 2005/12/28 09:25:08 opalod Exp $ 
...
CONTAINS
   ...
   SUBROUTINE obc_vol ( kt )
      ...
      DO jj = 1, jpj
         DO ji = 1, jpi
            zCflxemp = zCflxemp + ( (emp(ji,jj)*obctmsk(ji,jj) )/rauw)*e1v(ji,jj)*e2u(ji,jj)
         END DO
      END DO
