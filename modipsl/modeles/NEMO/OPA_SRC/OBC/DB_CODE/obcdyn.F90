...
!restore based on position -- but do not use
              ...
              do jk = 1, jpkm1
                 do jj = 1, jpj
                    ua(ji,jj,jk) = ua(ji,jj,jk) + uemsk(jj,jk)*&
                         zin*(ufoe(jj,jk)-ua(ji,jj,jk)) * umask(ji,jj,jk)
                 enddo
              enddo
           enddo
        enddo
...
!           DO jk = 1, 1
!              DO jj = 1, jpj
!                 write(350+narea,'(3(i3,1x),3(e12.6,1x))')ji,jk,jj,ua(ji,jj,jk),ufow(jj,jk)
!              enddo
!           enddo
!        enddo
...
!!restore based on position -- but do not use
              ...
              do jk = 1, jpkm1
                 do jj = 1, jpj
                    ua(ji,jj,jk) = ua(ji,jj,jk) + uwmsk(jj,jk)*&
                         zin*(ufow(jj,jk)-ua(ji,jj,jk)) * umask(ji,jj,jk)
                 enddo
              enddo
           enddo
        enddo
...
!!restore based on position -- but do not use
              ...
              do jk = 1, jpkm1
                 do ji = 1, jpi
                    va(ji,jj,jk) = va(ji,jj,jk) + vsmsk(ji,jk)*&
                         zin*(vfos(ji,jk)-va(ji,jj,jk)) * vmask(ji,jj,jk)
                 enddo
              enddo
           enddo
        enddo
