MODULE obcrst
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/OBC/obcrst.F90,v 1.5 2005/12/28 09:25:08 opalod Exp $ 
...
CONTAINS
   ...
   SUBROUTINE obc_rst_wri ( kt )
      ...
      IF( ( mod(kt,nstock) == 0 ) .OR. ( kt == nitend ) ) THEN
         ...
         IF( ios > 0 ) THEN
            IF(lwp) WRITE(numout,*) '      '
            IF(lwp) WRITE(numout,*) '        Pbm to OPEN the restart.obc.output file ' 
            IF(lwp) WRITE(numout,*) '      '
            nstop = nstop + 1   
         END IF
...
# endif 
   ...
   SUBROUTINE obc_rst_lec
      ...
      OPEN( UNIT   =  inum,       &
            ...
            FORM   = 'UNFORMATTED' )
      IF( ios > 0 ) THEN
         IF(lwp) WRITE(numout,*) '        Pbm to OPEN the restart.obc file ' 
         nstop = nstop + 1   
      END IF
      ...
      IF( ( it0-it1 ) /= 1 .AND. abs(nrstdt) == 1 ) THEN
          IF(lwp) THEN
             ...
             WRITE(numout,*) '        =============='
             WRITE(numout,*) '        we stop in obc_rst_lec routine. Verify the file or rerun with the value'
             WRITE(numout,*) '        0 for the control of time parameter nrstdt'
             WRITE(numout,*) ' ' 
          END IF
          nstop = nstop + 1
      END IF
      ...
      IF( lp_obc_east .AND. ( jpieob1 /= 0 ) ) THEN
         IF(lwp) THEN
            ...
            IF( jpieob0 /= jpieob1 ) THEN
               WRITE(numout,*) '         ==>>>> : Problem in obc_rst_lec, jpieob have changed'
               nstop = nstop + 1
            END IF
         END IF
      END IF
      ...
      IF( lp_obc_west .AND. ( jpiwob1 /= 0 ) ) THEN
         IF(lwp) THEN
            ...
            IF( jpiwob0 /= jpiwob1 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpiwob has changed'
               nstop = nstop + 1
            END IF
         END IF
      END IF
      ...
      IF( lp_obc_north .AND. ( jpjnob1 /= 0 ) ) THEN
         IF(lwp) THEN
            ...
            IF( jpjnob0 /= jpjnob1 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpjnob has changed'
               nstop = nstop + 1
            END IF
         END IF
      END IF
      ...
      IF( lp_obc_south .AND. ( jpjsob1 /= 0 ) ) THEN
         IF(lwp) THEN
            ...
            IF( jpjsob0 /= jpjsob1) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpjsob has changed'
               nstop = nstop + 1
            END IF
         END IF
      END IF
      ...
      IF( lp_obc_east .AND. ( jpieob1 /= 0 ) ) THEN
         IF(lwp) THEN
            IF( ied1 /= ied0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpjed has changed'
               nstop = nstop + 1
            END IF
            IF( ief1 /= ief0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpjef has changed'
               nstop = nstop + 1
            END IF
         END IF
      END IF
      ...
      IF( lp_obc_west .AND. ( jpiwob1 /= 0 ) ) THEN
         IF(lwp) THEN
            IF( iwd1 /= iwd0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpjwd has changed'
               nstop = nstop + 1
            END IF
            IF( iwf1 /= iwf0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpjwf has changed'
               nstop = nstop + 1
            END IF
         END IF
      END IF
      ...
      IF( lp_obc_north .AND. ( jpjnob1 /= 0 ) ) THEN
         IF(lwp) THEN
            IF( ind1 /= ind0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpind has changed'
               nstop = nstop + 1
            END IF
            IF( inf1 /= inf0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpinf has changed'
               nstop = nstop + 1
             END IF
          END IF
      END IF
      ...
      IF( lp_obc_south .AND. ( jpjsob1 /= 0 ) ) THEN
         IF(lwp) THEN
            IF( isd1 /= isd0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpisd has changed'
               nstop = nstop + 1
            END IF
            IF( isf1 /= isf0 ) THEN
               WRITE(numout,*) '        ==>>>> : Problem in obc_rst_lec, jpisf has changed'
               nstop = nstop + 1
            END IF
         END IF
      END IF
