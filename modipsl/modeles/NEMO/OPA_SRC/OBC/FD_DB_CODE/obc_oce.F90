MODULE obc_oce
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/OBC/obc_oce.F90,v 1.6 2006/05/10 17:38:46 opalod Exp $ 
...
!! FD add tangential velocity 03/08
   ...
   !!--------------------------------------
   INTEGER ::              & !: * namelist ??? *
      nbobc    = 3  ,      & !: number of open boundaries ( 1=< nbobc =< 4 ) 
...
! FD: inconsistency with obcfla.F90 and obcdta.F90, dimension should be jpj
...
! FD: inconsistency with obcfla.F90, dimension should be jpi,jpj
...
! FD      sshedta, ubtedta    !: array used for interpolating monthly data on the east boundary
! FD: add tangential velocity
      sshedta, ubtedta, vbtedta    !: array used for interpolating monthly data on the east boundary

   REAL(wp), DIMENSION(jpjed:jpjef,jpk,jptobc) ::   &  !:
! FD      uedta, tedta, sedta !: array used for interpolating monthly data on the east boundary
! FD: add tangential velocity
      uedta, vedta !: array used for interpolating monthly data on the east boundary
!DB jpjed <---- 1
...
! FD      sshwdta, ubtwdta    !: array used for interpolating monthly data on the west boundary
! FD: add tangential velocity
      sshwdta, ubtwdta, vbtwdta    !: array used for interpolating monthly data on the west boundary

   REAL(wp), DIMENSION(jpjwd:jpjwf,jpk,jptobc) ::   &  !:
! FD      uwdta, twdta, swdta !: array used for interpolating monthly data on the west boundary
! FD: add tangential velocity
      uwdta, vwdta !: array used for interpolating monthly data on the west boundary
!DB
...
! FD: inconsistency with obcfla.F90 and obcdta.F90, dimension should be jpi
...
! FD      sshndta, vbtndta   !: array used for interpolating monthly data on the north boundary
! FD: add tangential velocity
      sshndta, ubtndta, vbtndta   !: array used for interpolating monthly data on the north boundary

   REAL(wp), DIMENSION(jpind:jpinf,jpk,jptobc) ::   &  !:
! FD      vndta, tndta, sndta !: array used for interpolating monthly data on the north boundary
! FD: add tangential velocity
      undta, vndta !: array used for interpolating monthly data on the north boundary
!sujie
...
! FD      sshsdta, vbtsdta    !: array used for interpolating monthly data on the south boundary
! FD: add tangential velocity
      sshsdta, ubtsdta, vbtsdta    !: array used for interpolating monthly data on the south boundary

   REAL(wp), DIMENSION(jpisd:jpisf,jpk,jptobc) ::    &    !:
! FD      vsdta, tsdta, ssdta   !: array used for interpolating monthly data on the south boundary
! FD: add tangential velocity
      usdta, vsdta   !: array used for interpolating monthly data on the south boundary
