...
! FD: add tangential velocity
      uedta, vedta, tedta, sedta !: array used for interpolating monthly data on the east boundary
...
! FD: add tangential velocity
      uwdta, vwdta, twdta, swdta !: array used for interpolating monthly data on the west boundary
...
! FD: add tangential velocity
      undta, vndta, tndta, sndta !: array used for interpolating monthly data on the north boundary
...
! FD: add tangential velocity
      usdta, vsdta, tsdta, ssdta   !: array used for interpolating monthly data on the south boundary
