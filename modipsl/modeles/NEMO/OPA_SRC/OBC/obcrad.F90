...
#  include "obc_vectopt_loop_substitute.h90"
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/OBC/obcrad.F90,v 1.5 2005/12/28 09:25:08 opalod Exp $ 
...
CONTAINS
   SUBROUTINE obc_rad( kt )            ! No open boundaries ==> empty routine
      INTEGER, INTENT(in) :: kt
      if(lwp) WRITE(numout,*) 'obc_rad: You should not have seen this print! error?', kt
   END SUBROUTINE obc_rad
#endif
