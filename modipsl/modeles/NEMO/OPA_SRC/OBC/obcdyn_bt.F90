MODULE obcdyn_bt
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/OBC/obcdyn_bt.F90,v 1.1 2005/12/28 09:25:07 opalod Exp $ 
...
# elif defined key_dynspg_ts
   ...
   SUBROUTINE obc_dyn_bt_east 
      ...
      DO ji = nie0, nie1
         DO jk = 1, jpkm1
            DO jj = 1, jpj
!ylu               ua(ji,jj,jk) = ( ua(ji,jj,jk) + sshfoe_b(ji,jj) ) * uemsk(jj,jk)
!ylu               ua(ji,jj,jk) = ( ua(ji,jj,jk) + ua_e(ji,jj) * hur(ji,jj) ) * uemsk(jj,jk)
            END DO
         END DO
      END DO
      DO ji = nie0p1, nie1p1
   ...
   SUBROUTINE obc_dyn_bt_west 
      ...
      DO ji = niw0, niw1
         DO jk = 1, jpkm1
            DO jj = 1, jpj
!ylu               ua(ji,jj,jk) = ( ua(ji,jj,jk) + sshfow_b(ji,jj) ) * uwmsk(jj,jk)
!ylu               ua(ji,jj,jk) = ( ua(ji,jj,jk) + ua_e(ji,jj) * hur(ji,jj) ) * uwmsk(jj,jk)
            END DO
         END DO
         DO jj = 1, jpj
   ...
   SUBROUTINE obc_dyn_bt_north 
      ...
      DO jj = njn0, njn1
         DO jk = 1, jpkm1
            DO ji = 1, jpi
!ylu               va(ji,jj,jk) = ( va(ji,jj,jk) + sshfon_b(ji,jj) ) * vnmsk(jj,jk)
!ylu               va(ji,jj,jk) = ( va(ji,jj,jk) + va_e(ji,jj) * hvr(ji,jj) ) * vnmsk(jj,jk)
            END DO
         END DO
      END DO
      DO jj = njn0p1, njn1p1
   ...
   SUBROUTINE obc_dyn_bt_south 
      ...
      DO jj = njs0, njs1
         DO jk = 1, jpkm1
            DO ji = 1, jpi
!ylu               va(ji,jj,jk) = ( va(ji,jj,jk) + sshfos_b(ji,jj) ) * vsmsk(jj,jk)
!ylu               va(ji,jj,jk) = ( va(ji,jj,jk) + va_e(ji,jj)* hvr(ji,jj)) * vsmsk(jj,jk)
            END DO
         END DO
         DO ji = 1, jpi
