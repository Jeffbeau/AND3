MODULE in_out_manager   
  ...
  !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/in_out_manager.F90,v 1.12 2006/04/10 15:46:04 opalod Exp $ 
  ...
  INTEGER ::                &  !:
       ...
       numsss     = 66 ,      &  !: logical unit for surface salinity data
...
!!DB: 2009.10.01
  INTEGER ::   numout2    = 9   ! logical unit for (new) run_info.out file
