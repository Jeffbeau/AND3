...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/LDF/ldftra.F90,v 1.4 2005/03/27 18:35:07 opalod Exp $ 
...
#elif defined key_traldf_smag
      CALL ldf_tra_smag( ll_print )           ! aht = 2D coef. = F( longitude, latitude )
#elif defined key_traldf_c1d
