...
#  include "ldfdyn_substitute.h90"
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/DYN/dynldf_bilapg.F90,v 1.8 2005/09/02 15:45:23 opalod Exp $ 
...
CONTAINS
   SUBROUTINE dyn_ldf_bilapg( kt )               ! Dummy routine
      if(lwp) WRITE(numout,*) 'dyn_ldf_bilapg: You should not have seen this print! error?', kt
   END SUBROUTINE dyn_ldf_bilapg
#endif
