MODULE dynhpg
   ...
   !!----------------------------------------------------------------------
   !!   dyn_hpg      : update the momentum trend with the horizontal
...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Header: /home/opalod/NEMOCVSROOT/NEMO/OPA_SRC/DYN/dynhpg.F90,v 1.10 2005/12/21 10:46:37 opalod Exp $ 
...
CONTAINS
   ...
   SUBROUTINE dyn_hpg( kt )
      ...
      !!      level. s-coordinates ('key_s_coord'): a corrective term is added
